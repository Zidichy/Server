...
This nginx & it's configs are set to work with Organizr & with HTTP Authentication. Configured to require admin login when trying to reach plex/sonarr ect through domain's subdir.
